...
export const ThumbUpIcon: React.FC = () => (
    <svg className="w-5 h-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 18.734V11a2 2 0 00-2-2H4a2 2 0 00-2 2v6a2 2 0 002 2h1.263a2 2 0 011.554.72l1.96 2.352A1 1 0 0010.5 22H14a2 2 0 002-2v-4a2 2 0 00-2-2h-2.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 0111.263 3h4.017c.163 0 .326.02.485.06L17 3.266V9a2 2 0 002 2z" />
    </svg>
);

export const WarningIcon: React.FC<{severity?: 'warning' | 'error' | 'info'}> = ({ severity = 'warning'}) => {
    const colorClass = severity === 'error' ? 'text-red-500' : severity === 'warning' ? 'text-amber-500' : 'text-blue-500';
    return (
...
export const CheckDoubleIcon: React.FC = () => (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4" transform="translate(-4 -2)"/>
    </svg>
);

export const InfoIcon: React.FC<{className?: string; title?: string}> = ({className = "w-6 h-6", title}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const CircleIcon: React.FC<{className?: string}> = ({ className = "w-4 h-4" }) => (
...
export const ShieldCheckIcon: React.FC<{className?: string}> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.955a11.955 11.955 0 0018 0c0-1.72-.321-3.354-.9-4.869z" />
    </svg>
);
...
export const TeamIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m6 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);